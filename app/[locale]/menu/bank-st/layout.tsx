...
export const metadata: Metadata = {
    ...
    keywords: 'Bank St, Ottawa, Yemen gate, restaurant, yemeni cuisine, middle-eastern food, Canada, catering, menu, مظبي , مندي , خليجي ,يمني , اكل خليجي, اكل يمني, فطور يمني, عربية ,باب اليمن',
  }
